...
//    public static final String DOMAIN_NAME = "https://www.kiranbachhav.com/";
    ...
    public static final String API_MEDICAL_RECEIVED_ORDER = DOMAIN_NAME + "emedical/api/medicalreplytoorder";
    ...
    public static final String API_GET_NEARBY = DOMAIN_NAME + "emedical/api/getnearby";
    public static final String API_POST_ORDER = DOMAIN_NAME + "emedical/api/createorder";
